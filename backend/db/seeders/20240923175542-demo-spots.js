    ...
    await Spot.bulkCreate([
      {
        ...
        lng: 139.7036, 
        name: "1st Mission", 
        description: "Around the corner from Shinjuku station, enjoy the many shopping outlets in the areas.",
        price: 53.00,
      },
      {
        ownerId: 1,
      ...
      },
      {
        ...
        lng: 139.704051, 
        name: "The Incident", 
        description: "Cozy area where things happen, a place full of energy! It's near shibuya stations and many shopping amenities", 
        price: 60.00,
      },
      {
        ownerId: 6,
      ...
      },
      {
        ...
        lng: -59.6171,
        name: "Dagon's Domain",
        description: "Saturated bamboo and polinated Lilies, towels provided. Bring Sleeping Bags*",
        price: 100.00,
      },
      {
        ownerId: 4,
